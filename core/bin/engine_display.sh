...
DISP_SEL_BIN="${DISP_SEL_BIN:-rofi}"
DISP_SEL_THEME="${DISP_SEL_THEME:-$HOME/.config/rofi/themes/shared/menu_generic.rasi}"
DISP_CONF_THEME="${DISP_CONF_THEME:-$HOME/.config/rofi/themes/display_confirm.rasi}"
DISP_SEL_ARGS="${DISP_SEL_ARGS:--dmenu -theme $DISP_SEL_THEME}"
DISP_CONF_ARGS="${DISP_CONF_ARGS:--dmenu -theme $DISP_CONF_THEME}"
...
GLYPH_MONITOR="${DISP_GLYPH_MONITOR:-󰍹 }"
GLYPH_RESOLUTION="${DISP_GLYPH_RESOLUTION:-󰘚 }"
GLYPH_RATE="${DISP_GLYPH_RATE:-󱎫 }"
GLYPH_SCALE="${DISP_GLYPH_SCALE:-󰹯 }"
GLYPH_ROTATION="${DISP_GLYPH_ROTATION:-󰑓 }"
GLYPH_BRIGHTNESS="${DISP_GLYPH_BRIGHTNESS:-󰃠 }"
GLYPH_FILTER="${DISP_GLYPH_FILTER:-󰃦 }"
GLYPH_CONFIRM="${DISP_GLYPH_CONFIRM:-󰗹 }"
...
PROM_ROTATIONS="${DISP_PROM_ROTATIONS:-normal\nleft\nright\ninverted}"
PROM_BRIGHTNESSES="${DISP_PROM_BRIGHTNESSES:-1.0\n0.9\n0.8\n0.7\n0.6\n0.5\npersonalizado}"
PROM_FILTERS="${DISP_PROM_FILTERS:-ninguno\nnearest\nbilinear}"
UNIT_RATE="${DISP_UNIT_RATE:- Hz}"
VAL_CUSTOM="${DISP_VAL_CUSTOM:-personalizado}"
VAL_CUSTOM_SCALE="${DISP_VAL_CUSTOM_SCALE:-personalizada}"
